...
// console.log(users.find(user => user.firstName === 'Madison' && user.lastName === 'Marshall')?.id);
...
// console.log(users.find(user => user.id === comments.text === 'OK great thanks?'));

// const comment = comments.find(comment => comment.text === 'OK great thanks');
// console.log(users.find(user => user.id === comment.userId));

// console.log(comments.find(comment => comment.text === 'OK great thanks').userId);
